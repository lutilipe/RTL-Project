...
SIGNAL \A_Controladora|ld_total_itens~2_combout\ : std_logic;
...
\A_Controladora|ld_total_itens~2\ : cycloneive_lcell_comb
-- Equation(s):
-- \A_Controladora|ld_total_itens~2_combout\ = (\A_Controladora|estado_atual.adiciona~q\) # (\A_Controladora|estado_atual.remove~q\)
...
PORT MAP (
	...
	combout => \A_Controladora|ld_total_itens~2_combout\);
...
-- Equation(s):
-- \A_Controladora|Selector1~3_combout\ = (\A_Controladora|ld_total_itens~2_combout\) # ((\A_Controladora|Selector1~0_combout\) # ((\A_Controladora|proximo_estado.verifica_saldo~0_combout\ & \A_Controladora|Selector1~2_combout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \A_Controladora|ld_total_itens~2_combout\,
...
PORT MAP (
	...
	ena => \A_Controladora|ld_total_itens~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
